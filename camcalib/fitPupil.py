...
sys.path.append(os.path.abspath('/home/ostap/Documents/slab/TEST/'))
sys.path.append(os.path.abspath('/home/ostap/Documents/slab/TEST/shared_modules/'))
...
class WebcamVideoStream:
    def __init__(self, src=None,fifo=None):
        ...
        try:
            ...
            self.image =  np.fromstring(raw_image,dtype='uint8').reshape((self.height,self.width,3))
        except:
